...
// GetContextWithRequestID ...
func GetContextWithRequestID(c *gin.Context) context.Context {
	return context.WithValue(context.Background(), ContextRequestIDKey, GetRequestID(c))
}

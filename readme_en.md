...
[![license](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat)](https://github.com/TencentBlueKing/bk-iam-search-engine/blob/master/LICENSE.txt) [![Release Version](https://img.shields.io/badge/release-1.0.0-brightgreen.svg)](https://github.com/TencentBlueKing/bk-iam-search-engine/releases) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/TencentBlueKing/bk-iam-search-engine/pulls)

## Overview

BK-IAM-SEARCH-ENGINE is docked to [BK-IAM](https://github.com/TencentBlueKing/bk-iam), it will sync all the policies, analysis and index, provide API for optimizing user experience related to permission request/view.
